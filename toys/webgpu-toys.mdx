...
Every toy in the collection requires WebGPU. Below is the complete list:

<AccordionGroup>
  <Accordion title="Featured Toys (7 toys)">
    1. **Aurora Painter** - Paint flowing aurora ribbons (rank 1)
    2. **Bioluminescent Tidepools** - Sketch glowing currents (rank 2)
  ...
  <Accordion title="Archived Toys (17 toys)">
